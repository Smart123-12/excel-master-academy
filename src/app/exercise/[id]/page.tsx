...
import { ArrowLeft, Heart, Zap, Clock, Sparkles, CheckCircle2, AlertTriangle, Lightbulb, Check, X, ShieldAlert } from 'lucide-react';
...
export default function ExercisePage({ params }: PageProps) {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-dark overflow-hidden font-sans">
      {/* Top Header Row */}
      <header className="flex items-center justify-between px-6 py-4 bg-white dark:bg-dark-light border-b border-[var(--border-color)] shadow-sm shrink-0 z-30 select-none">
        ...
        <div className="flex items-center gap-6">
          ...
          {/* Timer */}
          <div className="flex items-center gap-2 bg-gray-100 dark:bg-dark px-3.5 py-1.5 rounded-xl border border-[var(--border-color)]">
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
        ...
        <div className="w-full lg:w-[40%] flex flex-col bg-white dark:bg-dark-light border-r border-[var(--border-color)] overflow-y-auto p-6 z-20">
          <div className="space-y-6 flex-1">
            ...
            {/* Expected Answer Box */}
            <div className="p-4 bg-emerald-50/25 dark:bg-emerald-950/5 border border-emerald-150/40 rounded-2xl">
          ...
          <div className="border-t border-[var(--border-color)] pt-6 mt-6 shrink-0 space-y-3">
            {statusMessage && (
            ...
            <AnimatePresence>
              {showSolution && (
                <motion.div
                  ...
                  className="overflow-hidden border border-[var(--border-color)] rounded-2xl bg-gray-50 dark:bg-dark p-4 mt-2"
                >
