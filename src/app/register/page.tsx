...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redirect to dashboard on register
      ...
      >
        <GlassCard className="p-8 shadow-2xl">
          ...
          <div className="text-center mb-8 select-none">
            ...
            <h2 className="text-xl font-bold text-[var(--text-primary)] mt-3">Start Learning Free!</h2>
            <p className="text-xs text-gray-400 mt-1">Create an account and master spreadsheets hands-on</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="text-xs text-gray-400 font-bold uppercase block mb-1.5">Password</label>
          ...
          <div className="relative my-6 select-none">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white dark:bg-dark-light px-3 text-gray-400 font-semibold">Or Register With</span>
            </div>
          </div>
          ...
          <p className="text-xs text-center text-gray-400 mt-8">
            ...
            <Link href="/login" className="text-emerald-600 dark:text-emerald-450 hover:underline font-bold">Sign In</Link>
          </p>
        </GlassCard>
      </motion.div>
    </div>
